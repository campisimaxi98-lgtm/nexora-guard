...
malware llega **instalándose**. El baseline (`nexora-apps-baseline.json`)
...
**Almacenamiento**: `nexora-usage-baseline.json`, una muestra por app y
...
`nexora-config.json`). Los valores de las tablas de arriba son los
