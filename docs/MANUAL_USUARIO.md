...
NEXORA GUARD observa tu teléfono y te dice, con evidencia,
...
> de un problema. Nexora vigila esas distorsiones y te dice dónde mirar.

## La primera vez que la abres

Nexora te muestra tres pantallas cortas (qué es, qué **no** es, y por
...
un fallo de Nexora, es diseño de iOS.
...
arranque. Nexora no inspecciona tu tráfico: solo lee contadores del SO.
...
error. También ves cuánto ocupa la caché propia de Nexora, con un botón
...
<p align="center">
  <img src="images/alerta-critica.png" width="280" alt="Notificación local: Nexora veredicto CRÍTICO" />
</p>
...
Como en el Nexora de escritorio:
...
- **Captura en segundo plano**: incluso con la app cerrada, mínimo cada
  15 minutos (lo impone Android, no Nexora), con opción de hacerlo
...
Mantén pulsada la pantalla de inicio → **Widgets** → Nexora: el
...
para desinstalarla o revocarle permisos ahí mismo. Nexora no puede
...
comparable entre dispositivos y con Nexora para Windows.

## Idioma

La app está en **español e inglés** — español por defecto, como toda la
familia Nexora. El botón 🌐 de la barra superior cambia al inglés y la
...
notas gasta casi nada. Por eso Nexora compara **cada app consigo
...
concedido. Antes de eso Nexora no dice nada — prefiere callarse a
inventar. Y ojo con lo que esto significa: si el teléfono ya estaba
comprometido cuando instalaste Nexora, ese consumo alto es lo que
...
app que se instaló justo en ese periodo, Nexora te lo dice.
