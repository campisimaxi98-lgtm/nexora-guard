# Probar Nexora en el emulador (sin teléfono)
...
<p align="center">
  <img src="images/resumen.png" width="240" alt="Nexora corriendo en el emulador — pestaña Resumen" />
  &nbsp;&nbsp;
  <img src="images/dispositivo.png" width="240" alt="Nexora corriendo en el emulador — pestaña Dispositivo" />
</p>

> Capturas reales de la app corriendo en el AVD "Medium Phone" con
> Android 16 (API 36).
...
el APK universal del último release, lo instala y abre Nexora. Ideal
...
4. Descarga el APK **universal** del
   [último release](https://github.com/nexora-app-org/nexora-guard/releases/latest)
   y **arrástralo sobre la ventana** del emulador: se instala solo.
5. Abre Nexora desde el cajón de apps.
...
& "$sdk\platform-tools\adb.exe" install -r Nexora-Mobile-Inspector-<v>-android-universal.apk
& "$sdk\platform-tools\adb.exe" shell monkey -p com.nexora.guard 1
```
