# Flutter para Nexora — por qué la edición móvil se escribió así

## 1. Objetivo de este documento

La edición Windows de Nexora está escrita en Rust y su repo explica por qué
(ver `docs/RUST_PARA_NEXORA.md` en `nexora-windows-inspector`). Este
...
(`nexora/collectors`) con dos métodos: `collect` y `documentsPath`. El
