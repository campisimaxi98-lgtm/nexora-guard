...
import 'package:nexora_guard/core/baseline_store.dart';
import 'package:nexora_guard/core/history_store.dart';
import 'package:nexora_guard/core/models.dart';
import 'package:nexora_guard/core/rule_engine.dart';
import 'package:nexora_guard/core/usage_baseline.dart';
...
void main() {
  ...
  group('BaselineStore.installedWithin', () {
    ...
    setUp(() async {
      dir = await Directory.systemTemp.createTemp('nexora-baseline-v080');
    });
    ...
    test('un baseline previo a v0.8.0 (sin marca) no rompe', () async {
      await File('${dir.path}/nexora-apps-baseline.json').writeAsString(
        jsonEncode({
          'packages': {
            'com.legacy': {
              'firstSeenMillis': now,
