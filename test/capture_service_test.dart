...
import 'package:nexora_guard/core/config_store.dart';
import 'package:nexora_guard/core/models.dart';
import 'package:nexora_guard/core/rule_engine.dart';
import 'package:nexora_guard/platform/capture_service.dart';
import 'package:nexora_guard/platform/collectors.dart';
...
void main() {
  ...
  setUp(() async {
    tmp = await Directory.systemTemp.createTemp('nexora-capture-test');
  });
