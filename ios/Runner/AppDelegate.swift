...
/// Registra el canal `nexora/collectors` que el núcleo Dart consume.
...
/// contrato `nexora/collectors` (docs/ARCHITECTURE.md). Los campos que
...
enum IosCollectors {
  ...
  private static func jailbreakIndicators() -> [String] {
    ...
    let probe = "/private/nexora-jb-probe-\(UUID().uuidString).txt"
