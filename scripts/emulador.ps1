...
# release y abre Nexora — todo en un comando.
#
...
$repo = 'nexora-app-org/nexora-guard'
...
$dl = Join-Path $env:TEMP 'nexora-apk'
...
& $adb shell monkey -p com.nexora.guard -c android.intent.category.LAUNCHER 1 | Out-Null
Write-Host 'Nexora abierto en el emulador ✔' -ForegroundColor Green
