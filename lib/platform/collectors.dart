/// Puente al canal nativo `nexora/collectors`.
///
...
class PlatformCollectors {
  ...
  static const MethodChannel _channel = MethodChannel('nexora/collectors');
  ...
  /// Borra la caché propia de Nexora. Devuelve los bytes liberados
  ...
  /// Quien envía es la app que el usuario elija — Nexora sigue sin
