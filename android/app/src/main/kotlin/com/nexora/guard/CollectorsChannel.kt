...
/**
 * Canal `nexora/collectors`: una sola implementación registrable tanto
...
object CollectorsChannel {
    ...
    const val NAME = "nexora/collectors"
            ...
            when (call.method) {
                ...
                "notifyCritical" -> result.success(
                    NotificationHelper.notifyCritical(
                        context,
                        call.argument<String>("title") ?: "Nexora",
                ...
                "refreshWidget" -> {
                    NexoraWidgetProvider.updateAll(context)
                    result.success(null)
                }
     ...
     * Nexora sigue sin poder tocar la red.
     */
